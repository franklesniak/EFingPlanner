...
- **Human-review coverage stays at full coverage** -- every file a batch creates or edits that a child or a parent reads is human-edited, not sampled. The Full Build's sampling fallback is not adopted.
