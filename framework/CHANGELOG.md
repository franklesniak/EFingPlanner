...
- **Corrected what the budget worksheet claims about the whole-trip total.** It said adults add flights to "work out the full total". Flights plus the child's slices is not the full total -- insurance, passport and entry costs, and phone service all sit outside it -- so the page now says adults add flights on their own page along with things the child never sees. A parent treating that figure as the affordability check was reading an understated floor.
