...
You are here: Phase 7 (Itinerary Building), First Taste step 12 of 13.
Previous: [33 Budget Basics, First Pass](../phase_06_lodging_food_budget/33_budget_basics_first_pass.md) | Next: [53 Reflection and Handoff](../phase_08_readiness_final/53_reflection_and_handoff.md)
...
Finish your must-see list, set aside what does not fit, and make a couple of backup plans.
...
A good planner cannot fit everything -- and that is fine. Knowing what to keep, what to
...
2. **Make your cut list** on a [Cut List page](../../templates/cut_list.md). For each
   ...
   Cutting something is not losing it -- "save for a future trip" keeps it for later.
3. **Choose your one special pick.** Pick the **single** thing you most want on this trip.
...
4. **Make two backup plans** on a [Backup Plan page](../../templates/backup_plan.md) for
   ...
   - Attraction closed or too crowded -- what is a good nearby swap?
   (Other backups to consider: tired day, restaurant full, transit delay.)

## Workspace

Use your Cut List page, your Backup Plan page, and your My Calls page for the one special
pick.
...
Your must-see list, your cut list (with "save for future" notes), your one special pick on
the My Calls page, and two backup plans.

## Stop Point

You are done when you have a short must-see list, at least two things on your cut list, one
special pick written and initialed, and two backup plans. Short is good -- this is about
choosing, not listing everything.

## Source Check

No new sources needed unless you looked something up. This session uses the cards and picks
you already made.
...
If you have extra energy, add one more backup plan, or write one line about *why* something
on your cut list would be great to save for a future trip. If not, you are done.

## Parent Notes

The one unconditional pick is the ownership centerpiece -- help your child choose one you
can genuinely keep. Show the three blocks (budget, bookability, safety/feasibility for
everyone, including any lower-stamina traveler) *before* they commit, and steer gently
toward an affordable, bookable pick. A grown-up vote does not override this one -- only the
three blocks do -- so scope it to a single keepable pick. Honor cut-list "save for future"
notes as real; nothing here is wasted. This session teaches "good enough is good enough" --
resist the urge to make it exhaustive.
