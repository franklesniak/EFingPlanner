...
You are here: Phase 7 (Itinerary Building). Not a First Taste step. Previous: [42 Reservations and Timed Entries](42_reservations_and_timed_entries.md) | Next: [44 Backup Plans and Cut List](44_backup_plans_and_cut_list.md)
...
3. For any day that needs it, write one way to make it gentler. You could move a big thing, add a break, or swap in a rest day. Keep your special pick and its place. Write each change on the day cards it touches. If it moves or drops something on your Reservation Watchlist, fix that row too. With booked dates, ask a grown-up for its new opening date. Then go down the checks again for each day you changed. If every day passes, write that.
4. Write your flags for the adults. If a day is hard on one traveler, say who, by how they're related to you.

**Everyone's energy.** Go through every traveler's profile, and look at the stamina notes. An older relative, for example a grandparent, may tire more easily on a long trip, even with no trouble walking. Hot, sticky weather makes that matter more. If someone like that is coming, a kinder plan is usually shorter and gentler than your family's maximum trip length on your Trip-Basics card: fewer cities, more nights in each, and a rest day built in. With one base, it means fewer long rides out from it. The grown-ups approved your route at Checkpoint 4, so fewer cities, or fewer rides out, is their call. Write it as a flag for them, and keep the city with your special pick in it. They can make that change at Checkpoint 5. Here, make days gentler inside your route. If your dates are booked, that row holds the booked trip length, and the length stays.
...
**If your special pick can't work for everyone.** A grown-up may tell you your special pick isn't doable for every traveler. That's one of the three blocks. Choose a new pick with them, the way you did in Session 26. Pick it from your attraction cards for places on your route. Write it on your My Calls page in place of the blocked pick. They write "got it" beside it. Write must-do on its card too. Put it on your must-do list, on the day card for its place, and on your Reservation Watchlist if it needs booking, with its row filled in as in Session 42. Take the blocked pick off all three. It needs no more research. If your Session 39 budget counted the blocked pick's ticket, swap in the new one's, and check your band again. Then go down the checks again for that day.

**Taking care of yourself on the trip.** Pacing is for you too. Kids get tired and hot on busy trips, just like grown-ups.

- **Jet lag.** If your trip has a big time change, the first two or three days can feel strange and sleepy. That's normal. Get outside in the daylight. The gentle early days in your plan are for you too.
- **Heat and water.** On hot walking days, carry water and drink before you feel thirsty. Say so when you need a sit in the shade.
...
You are done when you've gone through the checks once, marking each one yes or no, and either marked at least one day you'd make gentler and checked it again, or written that every day passed, and you've written your list of flags for the adults. Each change you made is on its day cards, and on your watchlist if it moved or dropped something there. Finding even one thing to fix is a finished review, and so is a plan that passes every check. "Not sure" is a fine note on any check. If you didn't write your third trade-off report in Session 34, you're done once it's written here too. If your special pick hit a block, you've chosen a new one with a grown-up. It's on your My Calls page with their "got it", and on your must-do list, its day card and, if it needs booking, your watchlist, with its row filled in, in place of the blocked one. If your budget counted the old pick's ticket, it uses the new one's. You've checked that day again.

## Source Check

Log your destination pack's transportation basics page in your Source Log, with the date you read it. Add any official site you used for walking or stairs too. Station and building details can change, so mark them for a grown-up to check before the trip.
...
Review the pacing checks after the session. The biggest one is energy. A lower-stamina traveler on a long trip is an energy factor even with no mobility limits, and heat makes it matter more. With one on the roster, the kinder shape is usually shorter and gentler than your maximum: fewer cities, more nights in each, and a built-in rest day, or, with one base, fewer long rides out from it. With the dates booked, the same shape fits inside the booked trip. If your child flags fewer cities or fewer rides out, decide it at Checkpoint 5, where Approved with changes carries a route change into the draft, the budget and the watchlist.

If you booked dates in a different season from the Checkpoint 1 recommendation, tell your child which season it is, for the hot-weather check. A broad word such as "late spring" is enough, with no dates.

Your child flags accessibility trouble spots, and you handle the fixes. Step-free routes, station elevators, accessible lodging and luggage help are yours to verify; the [adult-only logistics](../../parent_guide/adult_only_logistics.md) page lists them. The walking and stair detail for your destination is in the pack's transportation basics page.
...
If the pacing check shows the special pick is not doable for every traveler, name that block and let your child choose a new pick with you, from their attraction cards for places on the route, as in Session 26. Write "got it" beside the new pick on their My Calls page. It goes on the must-do list, the day card for its place and, if it needs booking, the Reservation Watchlist, and the blocked pick comes off all three and needs no more research. Then your child runs the checks again for that day. Only the three blocks can change the pick.
