...
If your special pick on your My Calls page costs more than the band, a grown-up tells you which of the three blocks it hit. Then you choose a new pick with a grown-up, the way you did in Session 26. Pick it from your attraction cards for places on your route. Write it on your My Calls page in place of the blocked pick. The grown-up writes "got it" beside it. Write must-do on its card too. Put it on your must-do list, and take the blocked pick off. The blocked pick needs no more research. If your activities slice counted the blocked pick's ticket, use the new pick's ticket instead. Then add up your subtotal and check it against your band again, and fix your sentence.
...
| Overnight city | Cost per night, per room | Nights | Rooms (ask a grown-up) | Hotel total |
| --- | --- | --- | --- | --- |
| | | | | |
| | | | | |
| | | | | |
