...
3. **The other slices.** Do the same for local transit, activities and souvenirs. Fill in the rows on that page that said "later". They're yours now. In each one's "How to figure it" box, write "per day x ____ days". On the activities row, cross out "per ticket x ____ people" first. Your long-distance rides from Session 38 stay out of your subtotal, because the grown-ups price those.
   ...
   **Someone with you for only part of the trip?** Your Session 38 guesses count everyone on every day. If your Session 33 note says the number of us changes, count your traveler-days first: for each part of the trip, multiply how many of you are there by its days, and add the parts. Then, for food, local transit and activities, divide your Session 38 guess by all of you, and multiply by your traveler-days. Souvenirs stay per day. A grown-up can do the math.
...
5. **Check against your band.** Match the units first, the way you did in Session 33, but count all five slices now. Band per day for the family? Divide your subtotal by the total days in your Checkpoint 4 plan, and compare that. Band per person, per day? Multiply it by your travelers first, then compare the same way. Band a hotel tier? Check each hotel's cost per night against it.
