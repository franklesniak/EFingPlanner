...
Tell your child how many rooms to use for the hotel guess. If someone comes for only part of the trip, tell your child who is there on which days, by day number, so they can make the optional note. If your child made the part-trip note, use it when you decide the rooms and book the long rides, so each night and each leg fits everyone who is there.
