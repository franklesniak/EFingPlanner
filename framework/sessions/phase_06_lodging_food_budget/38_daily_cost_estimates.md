...
If you looked up any price today, add it to your Source Log with the date you checked. Prices move, so the date matters as much as the number. Changed a price into your family's money? Log your destination pack's money basics page, and where you found today's rate, with the date. If you only used numbers you already had, no new sources needed.
