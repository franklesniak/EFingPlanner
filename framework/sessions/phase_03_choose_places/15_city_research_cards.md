...
1. **City or region** and **why people go there.**
...
Record each city's sources in your Source Log with today's date. Prefer official city or tourism sites for facts; note anything (like ticket prices or hours) that a grown-up must re-check close to travel.
...
If you have extra energy, start a third city card, or add a "things I can't wait to see" item from your starred sights. If not, two cards is a complete job.
