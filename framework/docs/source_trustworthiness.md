...
- **Official attraction, museum, temple and park websites.** The best answer for hours, prices, closures and ticketing at that one place.
...
- **AI tools.** Off by default in this curriculum. When a family uses one, the [AI use rules](ai_use_rules.md) apply, and the tool never supplies a fact on its own.

## Match the source to the question

Before you look anything up, ask what kind of question you have. The answer decides where to look.
