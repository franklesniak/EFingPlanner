...
- **Neutral about who the child is.** A generic child is "your child," "the child," or **they** -- never "he," "she," or "he or she." Child-facing text stays in the second person ("you"), which sidesteps the problem entirely, so third-person pronouns should appear almost only in `parent_guide/` and builder-facing files. Age is written as a range, not a number: "roughly 9-11," "about ten," "a younger planner." Never assume a sibling, a two-parent household, a gender for a parent, or a specific family shape -- write "an adult," "the adults," "someone at home." QA grep before a batch ships: `grep -rniwE 'he|she|his|her|hers|himself|herself' framework/` (`-w` gives portable whole-word matching without the non-POSIX word-boundary escape). Confirm every hit is a quoted example rather than a real pronoun choice; there should be no real ones in this repository.
