...
- **Keep the session choreography exactly as written.** `Finished? Use the...`, `Stuck? Use the...`, `If you have extra energy...`, `...If not, you are done.`, and the seven mandatory fields are a designed executive-function support, not prose to vary. The contraction and dash rules above do not apply to them.
