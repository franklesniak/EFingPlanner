...
Before you compare individual hotels, compare the *areas* they sit in. Where you stay changes how much of your day you spend getting places. Use this for one overnight base at a time, with two or three candidate areas side by side.

Write the area names across the top, then fill down. If the grid gets too wide to print, split it into two tables rather than shrinking the text.

| What I'm comparing | Area 1 | Area 2 | Area 3 |
| --- | --- | --- | --- |
| Transit access — how easy is it to reach the places we want? | | | |
| Time cost of a cheaper place farther out | | | |
| Near a useful station? | | | |
| Neighborhood feel | | | |
