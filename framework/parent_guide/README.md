...
You do not have to read all of this before you start. This page is the quick-start. Read three short things, do four small setup actions, and begin.
...
2. [Adult and child roles](adult_roles.md) -- what adults own, what the child owns, and the safety boundary.
3. [Time and effort](time_and_effort.md) -- how much time this really takes, the try-then-commit on-ramp, and (for the person running the pilot) the pass/fail signals.
