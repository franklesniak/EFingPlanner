...
The full version of the one-time setup. The short version is in the [quick-start](README.md); [Session 00](../sessions/phase_00_setup/00_parent_setup.md) is the in-order companion. Plan on about 1-2 hours, once.

## The four setup actions (do these to begin)

<!-- density-exempt: X, not Y -- both contrasts in this list are required: step 1's kid-safe filter caveat, a safety rule the batch 1 brief keeps in full at this point of use, and step 3's kid-sized Budget Band, a Named concept whose full trip total the spec keeps an adult number (its What to Pin Early vs. What to Keep Open) -->
