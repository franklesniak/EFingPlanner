...
| --- | --- |
| Do we need entry documents? | Official government source (adults handle this) |
| What are a museum's hours? | The museum's own official website |
| What is fun in a city? | A guidebook plus travel websites |
| How long does a train take? | A transit planner or railway source |
| Is a hotel convenient? | A map plus hotel reviews |
| Is this current? | An official source, with the date you checked it |
